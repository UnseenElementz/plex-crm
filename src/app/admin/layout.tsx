...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <nav className="sticky top-0 z-50 glass border-b border-slate-700/50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4 md:space-x-8 w-full overflow-x-auto no-scrollbar">
              <Link href="/admin" className="text-xl font-bold gradient-text whitespace-nowrap shrink-0">
                Admin Panel
              </Link>
      ...
      <main className="py-4 md:py-6 relative">
        {children}
